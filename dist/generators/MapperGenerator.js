...
export class MapperGenerator extends BaseGenerator {
    async generate(options) {
        ...
        const filePath = this.pathResolver.layerPath(options.layer, 'infrastructure/mappers', `${names.pascal}Mapper.ts`);
        const barrelPath = this.pathResolver.layerPath(options.layer, 'infrastructure/mappers', 'index.ts');
...
//# sourceMappingURL=MapperGenerator.js.map